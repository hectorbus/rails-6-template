...
RSpec.describe RolesController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #permissions' do
      expect(get: '/roles/1/permissions').to route_to('roles#permissions', id: '1')
    end

    it 'routes to #permission' do
      expect(put: '/roles/1/permission/1').to route_to('roles#permission', id: '1', permission_id: '1')
    end
  end
end
